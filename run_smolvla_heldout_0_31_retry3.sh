...
OUT="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry3"
LOG="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry3.launch.log"
...
DATASET_SNAPSHOT="/home/anton/.cache/video-vam/cube-out-of-box-dataset"
RUN_ID_FILE="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry3.wandb_run_id"

mkdir -p "$PROJECT/outputs/train"
SPLIT_COPY="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry3.split.json"
MANIFEST_STAGING="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry3.manifest.json"
exec > >(tee -a "$LOG") 2>&1
