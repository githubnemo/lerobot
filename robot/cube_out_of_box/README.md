# Cube Out Of Box Task - RL Training Pipeline

This folder contains everything needed to train a robot to take a cube out of a box using:
...
- **Only save successful episodes** - where the gripper takes the cube out of the box!
...
```
- Trains a ResNet model to recognize "cube out of boxed" from images
- Takes ~5-10 minutes on GPU
- Model saved to `outputs/reward_classifier/cube_out_of_box`
