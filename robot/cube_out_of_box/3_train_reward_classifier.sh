...
# The classifier learns to recognize "cube out of boxed" vs "not touched" from images
...
OUTPUT_DIR="outputs/reward_classifier/cube_out_of_box"

echo "=============================================="
echo "    CUBE OUT OF BOX - REWARD CLASSIFIER TRAINING"
echo "=============================================="
echo ""
