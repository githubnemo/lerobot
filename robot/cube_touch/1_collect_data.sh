#!/bin/bash
# Step 1: Collect demonstration data for cube touch task
# Teleoperate the robot to touch the cube, press Right Arrow to save episode
...
DATASET_ROOT="./data/cube_touch_dataset"

echo "=============================================="
echo "    CUBE TOUCH - DATA COLLECTION"
echo "=============================================="
...
echo "Press Right Arrow when the gripper successfully touches the cube"
echo ""
...
python -m lerobot.scripts.lerobot_record \
    ...
    --teleop.id=shabby \
    --dataset.repo_id=nemo/cube_touch_dataset \
    --dataset.root="$DATASET_ROOT" \
    --dataset.single_task="touch the cube" \
