...
OUT="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818"
LOG="$OUT/train.log"
...
cp -f "$SPLIT_SOURCE" "$OUT/split_source.json"
...
$PYTHON - "$OUT/run_manifest.json" "$RUN_ID" "$SPLIT_SOURCE" "$DATASET_REVISION" <<'PY'
import json, sys
