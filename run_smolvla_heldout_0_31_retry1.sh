...
OUT="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry1"
LOG="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry1.launch.log"
...
RUN_ID_FILE="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry1.wandb_run_id"

mkdir -p "$PROJECT/outputs/train"
SPLIT_COPY="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry1.split.json"
MANIFEST_STAGING="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry1.manifest.json"
exec > >(tee -a "$LOG") 2>&1
