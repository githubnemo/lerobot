...
OUT="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry4"
LOG="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry4.launch.log"
...
RUN_ID_FILE="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry4.wandb_run_id"

mkdir -p "$PROJECT/outputs/train"
SPLIT_COPY="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry4.split.json"
MANIFEST_STAGING="$PROJECT/outputs/train/cube_out_of_box_il_smolvla_heldout_0_31_20260818_retry4.manifest.json"
exec > >(tee -a "$LOG") 2>&1
