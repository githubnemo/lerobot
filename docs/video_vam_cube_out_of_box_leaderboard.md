...
## Phase 6: Online Video Extraction & Coherent Data Augmentation Benchmark (2026-09-12 / 2026-09-13)

Trains SmolExpert on streaming temporal video windows (stride 1) with GPU-accelerated temporally coherent visual augmentations (photometric jitter, random crop/translation, mild Gaussian blur applied identically across all 5 causal frames). Validation and dual-evaluation sets (Eval-1 and Eval-2) remain strictly unaugmented for gold-standard benchmark comparison.

| date       | arm                                                        | Train Data                             | Eval-Set 1 RMSE (Hist) | Eval-Set 2 RMSE (New)  | best step   | budget                     | status        | notes                                                                                             |
| :--------- | :--------------------------------------------------------- | :------------------------------------- | :--------------------- | :--------------------- | :---------- | :------------------------- | :------------ | :------------------------------------------------------------------------------------------------ |
| 2026-09-12 | **Cosmos 3 Edge Video-LoRA + Online Augmentations**        | V1 Clean (eps 0–31, 4,688 windows)     | **13.82°** (h1 4.64°)  | **24.66°** (h1 10.00°) | step 16,500 | 25,000 steps               | **COMPLETED** | Outperforms unaugmented V1 zero-shot (14.26°). Eval-2 gap reflects V1-only training distribution. |
| 2026-09-12 | **Cosmos 3 Edge Video-LoRA + Online Augmentations**        | Scale-100 V2 (eps 0–89, 9,122 windows) | **15.48°** (h1 4.60°)  | **17.23°** (h1 5.08°)  | step 12,500 | 22,500 steps (patience 20) | **COMPLETED** | Matches static baseline (17.20°) on held-out Eval-2 under continuous dynamic visual perturbation. |
| 2026-09-13 | **Cosmos 2B (T=2 mode) Video-LoRA + Online Augmentations** | Scale-100 V2 (eps 0–89, 9,122 windows) | **15.57°** (h1 4.84°)  | **18.71°** (h1 6.32°)  | step 24,500 | 34,500 steps (patience 20) | **COMPLETED** | Unpooled 2400 tokens, state_t=2, Step 6k LoRA. Stable convergence under dynamic augmentation.     |
| 2026-09-13 | **FLUX.2 [klein] Base + Online Augmentations**             | Scale-100 V2 (eps 0–89, 9,122 windows) | **18.42°** (h1 10.93°) | **21.59°** (h1 10.74°) | step 2,000  | 12,000 steps (patience 20) | **COMPLETED** | Junction tap 256 tokens (6,144 channels), multi-reference. Early stopped cleanly at step 12k.     |
